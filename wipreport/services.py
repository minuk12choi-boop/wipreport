...
from .models import WipReportLotPath, WipMoveGroup, WipRefProductRule, WipRefModuleRule, WipRefExclusionTypeRule
from .ref_services import classify_product, classify_module, parse_issue_eqp, parse_prevent, area_from_eqp
...
def build_summary(filters):
    try:
        ...
        return {'error':'DB 연결 실패: MySQL 접속 정보를 확인해 주세요.'}
